...
char get_winner(char board[3][3])
{
    ...
    if ((board[0][0]=='X' && board[1][1]=='X'&& board[2][2]=='X')|| (board[2][0]=='X'&& board[0][2]=='X' && board[1][1]=='X'))
    {
        winner='X';
    } else if ((board[0][0]=='O' && board[1][1]=='O'&& board[2][2]=='O')|| (board[2][0]=='O'&& board[0][2]=='O' && board[1][1]=='O'))
    {
        winner='O';
    }
    while (winner=='-' && x < 3)
